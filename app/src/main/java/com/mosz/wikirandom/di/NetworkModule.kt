...
import com.mosz.wikirandom.data.remote.RandomArticleService
...
internal object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideService(retrofit: Retrofit): RandomArticleService =
        retrofit.create(RandomArticleService::class.java)
